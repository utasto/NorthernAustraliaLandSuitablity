...
makerasterFromTreePredictionChunks <- function(rootDir = NULL, catchment = NULL, templateR = NULL, att = NULL, modelType = NULL, numcpus = 1, bs = NULL){
  ...
  generateRaster(rootDir, catchment, templateR,att, modelType, bs)
}

generateRaster <- function(rootDir = NULL, catchment = NULL, templateR = NULL, att = NULL, modelType = NULL, bs = NULL){
...
MapRF <- function(att = NULL, model = NULL, catchment = NULL, templateR = NULL, theStack = NULL, rootDir = NULL, cpus = NULL, bs=NULL, isLog = F){
  ...
  cl<-makeCluster(numcpus,outfile="")
  registerDoParallel(cl)
  foreach(k=1:length(bs$row), .export= c("applyRFMapParallel", "convertToNumeric"), .packages=c('raster','rgdal', 'ranger')) %dopar% applyRFMapParallel(model, bs, templateR, theStack, chunkRasterDir, isnumeric, isLog)
  stopCluster(cl)


   makerasterFromTreePredictionChunks(rootDir = rootDir, catchment=catchment, modelType = model$treetype, templateR = templateR, att = att, numcpus = cpus, bs = bs)
...
applyRFMapParallel <- function(model = NULL, bs = NULL, templateR = NULL, theStack = NULL, outDir = NULL, isnumeric=NULL, isLog = F){
...
summariseRFModel <- function(modelPath= NULL){
  ...
  par(mai=c(1,2,1,1))
  barplot(imp, main=paste0("Variable Importance - ") , horiz=TRUE, col=rainbow(50), las=1, cex.names=.5, las=1)
